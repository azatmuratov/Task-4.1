...
public class UserServiceTest extends BaseIntegrationTest {
    ...
    public void createUserTest() throws Exception {
        UserRequest userRequest = new UserRequest("azat", "azatmuratov49@gmail.com",
                "2701", "Username", "User-lastname");
    ...
    public void getUserById() {
        ...
        user.setEmail("azatmuratov49@gmail.com");
        ...
        assertEquals("azatmuratov49@gmail.com", response.getEmail());
    }
}
