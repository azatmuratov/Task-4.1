...
@WithMockUser(username = "azat", password = "2701", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        userRequest = new UserRequest("azat", "azatmuratov49@gmail.com", "2701", "Username", "User-lastname");
    }
    ...
    void testHello() {
        try {
            ...
            assertEquals("azat", responseContent);
        } catch (Exception e) {
